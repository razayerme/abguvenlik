...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-12">
    ...
    <div id="avm" class="scroll-mt-32 bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-lg transition duration-300">
        <div class="grid grid-cols-1 md:grid-cols-3">
            <div class="md:col-span-1 bg-slate-100 relative h-64 md:h-auto">
                <img src="https://images.unsplash.com/photo-1519567241046-7f570eee3c9e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="AVM Güvenliği" class="absolute inset-0 w-full h-full object-cover">
            </div>
            <div class="md:col-span-2 p-8 md:p-10">
                <div class="flex items-center mb-4">
                    <div class="w-10 h-10 bg-slate-50 rounded flex items-center justify-center text-brand-red mr-4">
                     ...
                     <h2 class="text-2xl font-bold text-corporate-navy">Alışveriş Merkezi (AVM) Güvenliği</h2>
                </div>
    ...
    <div id="plaza" class="scroll-mt-32 bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-lg transition duration-300">
        <div class="grid grid-cols-1 md:grid-cols-3">
            <div class="md:col-span-1 bg-slate-100 relative h-64 md:h-auto order-1 md:order-last">
                 <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Plaza Güvenliği" class="absolute inset-0 w-full h-full object-cover">
            </div>
            <div class="md:col-span-2 p-8 md:p-10 order-2 md:order-first">
                 <div class="flex items-center mb-4">
                    <div class="w-10 h-10 bg-slate-50 rounded flex items-center justify-center text-brand-red mr-4">
                     ...
                     <h2 class="text-2xl font-bold text-corporate-navy">Plaza ve İş Merkezi Güvenliği</h2>
                </div>
                <p class="text-slate-600 mb-6 leading-relaxed">
    ...
    <!-- Service Item: Insaat -->
     <div id="insaat" class="scroll-mt-32 bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-lg transition duration-300">
        <div class="grid grid-cols-1 md:grid-cols-3">
            <div class="md:col-span-1 bg-slate-100 relative h-64 md:h-auto">
                <img src="https://images.unsplash.com/photo-1503387762-592deb58ef4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="İnşaat Güvenliği" class="absolute inset-0 w-full h-full object-cover">
            </div>
            <div class="md:col-span-2 p-8 md:p-10">
                <div class="flex items-center mb-4">
                    <div class="w-10 h-10 bg-slate-50 rounded flex items-center justify-center text-brand-red mr-4">
                     ...
                     <h2 class="text-2xl font-bold text-corporate-navy">İnşaat ve Şantiye Güvenliği</h2>
                </div>
                <p class="text-slate-600 mb-6 leading-relaxed">
    ...
    <!-- Service Item: Site -->
     <div id="site" class="scroll-mt-32 bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-lg transition duration-300">
        <div class="grid grid-cols-1 md:grid-cols-3">
            <div class="md:col-span-1 bg-slate-100 relative h-64 md:h-auto order-1 md:order-last">
                 <img src="https://images.unsplash.com/photo-1560518883-ce09059ee971?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Site Güvenliği" class="absolute inset-0 w-full h-full object-cover">
            </div>
            <div class="md:col-span-2 p-8 md:p-10 order-2 md:order-first">
                 <div class="flex items-center mb-4">
                    <div class="w-10 h-10 bg-slate-50 rounded flex items-center justify-center text-brand-red mr-4">
                     ...
                     <h2 class="text-2xl font-bold text-corporate-navy">Site ve Konut Güvenliği</h2>
                </div>
                <p class="text-slate-600 mb-6 leading-relaxed">
    ...
    <div id="hastane" class="scroll-mt-32 bg-white rounded-lg border border-slate-200 overflow-hidden hover:shadow-lg transition duration-300">
        <div class="grid grid-cols-1 md:grid-cols-3">
            <div class="md:col-span-1 bg-slate-100 relative h-64 md:h-auto">
                <img src="https://images.unsplash.com/photo-1586773860418-d37222d8fce3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Hastane Güvenliği" class="absolute inset-0 w-full h-full object-cover">
            </div>
            <div class="md:col-span-2 p-8 md:p-10">
                <div class="flex items-center mb-4">
                    <div class="w-10 h-10 bg-slate-50 rounded flex items-center justify-center text-brand-red mr-4">
                     ...
                     <h2 class="text-2xl font-bold text-corporate-navy">Hastane Güvenliği</h2>
                </div>
                <p class="text-slate-600 mb-6 leading-relaxed">
